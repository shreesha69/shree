    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
        ...
        <div className="bg-white dark:bg-gray-700 p-8 rounded-2xl shadow-lg flex flex-col gap-6 hover:scale-[1.02] transition-transform duration-300">
          <h3 className="text-3xl font-bold text-gray-800 dark:text-gray-200 tracking-wide">
            Get in Touch
          </h3>
        ...
        <form ref={formRef} onSubmit={submit} className="bg-white dark:bg-gray-700 p-8 rounded-2xl shadow-lg flex flex-col gap-4 hover:scale-[1.02] transition-transform duration-300">
          ...
          <input
            ...
            required
            className="p-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-cyan-400 transition duration-300 shadow-sm font-medium"
          />
          <input
            name="email"
          ...
          <button
            ...
            className="mt-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-400 text-white rounded-xl font-semibold flex items-center justify-center gap-2 hover:scale-[1.02] transition transform duration-300 shadow-md disabled:opacity-50"
          >
            {sent ? (
              <>
